...
render() {
  ...
  return (
    <>
        {this.state.provider == null ? 'Loading!' : (
          ...
          <div>
            ...
            <Card.Body>
              <Card.Subtitle text-color='grey'>
                {currProv.services_provided !== '' && currProv.services_provided !== undefined
              ...
              <Card.Text>
                ...
                {currProv.addresses[0].line_2 !== undefined && currProv.addresses[0].line_2 !== ''
                  ? ', ' + currProv.addresses[0].line_2
                  : ''}
                {currProv.addresses[0].city !== undefined && currProv.addresses[0].city !== ''
                  ? ', ' + currProv.addresses[0].city
                  : ''}
                {currProv.addresses[0].state !== undefined && currProv.addresses[0].state !== ''
                  ? ', ' + currProv.addresses[0].state
                  : ''}
                {currProv.addresses[0].zipcode !== undefined && currProv.addresses[0].zipcode !== ''
              ...
              <Card.Text>
                ...
                {currProv.phone_numbers[0].contact !== undefined && currProv.phone_numbers[0].contact !== ''
              ...
              <Card.Text>
                {currProv.bus_routes[0] !== undefined && currProv.bus_routes[0] !== ''
                  ? 'Bus Route(s): ' + currProv.bus_routes[0]
                  : ''}
              </Card.Text>
              <Card.Text>
                {currProv.website[0] !== undefined && currProv.website[0] !== ''
                  ? 'Website: ' + currProv.website[0]
                  : ''}
              </Card.Text>
              <Card.Text>
                Hours{': '}
                {currProv.hours.monday !== undefined && currProv.hours.monday !== ''
                  ? '\nMonday: ' +currProv.hours.monday 
                  : ''}
                  {/* <br/> */}
                {currProv.hours.tuesday !== undefined && currProv.hours.tuesday !== ''
                  ? '\nTuesday: ' + currProv.hours.tuesday
                  : ''}
                  {/* <br/> */}
                {currProv.hours.wednesday !== undefined && currProv.hours.wednesday !== ''
                  ? '\nWednesday: ' + currProv.hours.wednesday
                  : ''}
                {currProv.hours.thursday !== undefined && currProv.hours.thursday !== ''
                  ? '\nThursday: ' + currProv.hours.thursday
                  : ''}
                {currProv.hours.friday !== undefined && currProv.hours.friday !== ''
                  ? '\nFriday: ' + currProv.hours.friday
                  : ''}
                {currProv.hours.saturday !== undefined && currProv.hours.saturday !== ''
                  ? '\nSaturday: ' + currProv.hours.saturday
                  : ''}
                {currProv.hours.sunday !== undefined && currProv.hours.sunday !== ''
                  ...
                  ? (
                    ...
                    (
                      ...
                      ? (
                          ...
                          ? 'Additional information: ' + currProv.appointment.other_info
                          : ''
                        )
                      : ''
                    )
                  ...
                  (
                    currProv.application.other_info !== undefined
                      ? (
                          ...
                          ? 'Additional Information: ' + currProv.application.other_info
                          : '' 
                        )
                      : ''
                  ) 
              ...
              <Card.Text>
                {currProv.translation_available !== undefined && currProv.translation_available !== ''
              ...
              <Card.Text>
                {currProv.additional_information !== undefined && currProv.additional_information !== ''
                  ? 'Additional information: ' + currProv.additional_information
                  : ''
                }
              </Card.Text>
